...
mongoose.connect('mongodb+srv://wwmrAdmin:admin@initialclusters-rht6n.mongodb.net/wwMovieReferenceDB?retryWrites=true&w=majority', { useNewUrlParser: true });
...
let allowedOrigins = ['http://localhost:3000', 'http://worldwide-movie-reference.herokuapp.com', "http://localhost:1234"];
